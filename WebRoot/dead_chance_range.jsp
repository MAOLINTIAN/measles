...
<head>
		...
		<head>
			...
			<title>全国各省麻疹死亡率分年统计热力视图（单位：1/10万）</title>
			...
			<script src="js/rangeDead.js"></script>
		...
		<body style="background-color: black" onload="load()">
			<nav class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-header">
					...
					<div>
						<a href="##" class="navbar-brand " style="font-size: 22px;text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;全国各省麻疹死亡率分年统计热力视图（单位：1/10万）&nbsp;</a>
