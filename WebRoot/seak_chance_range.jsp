...
<head>
		...
		<head>
			...
			<title>全国各省麻疹发病率分年统计热力视图（单位：1/1万）</title>
			...
			<script src="js/rangeSeak.js"></script>
		...
		<body style="background-color: black" onload="load()">
			<nav class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-header">
					...
					<div>
						<a href="##" class="navbar-brand " style="font-size: 22px;text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;全国各省麻疹发病率分年统计热力视图（单位：1/1万）&nbsp;</a>
			...
			<section class="panel home" data-section-name="home">
				<div class="container-fluid" style="margin-top:0px;">
					<div class="row" style="text-align:center;">
						  ...
						  <div id="range_main" class="map col-lg-12 col-md-12 col-sm-12 col-xs-12"></div>
