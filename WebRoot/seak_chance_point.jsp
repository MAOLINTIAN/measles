...
<title>全国各省麻疹发病率分年统计散点视图（单位：1/1万）</title>
...
<script src="js/mapSeak.js"></script>
...
<body style="background-color: black" onload="load()">
			<nav class="navbar navbar-inverse navbar-fixed-top">
				<div class="navbar-header">
					...
					<div>
						<a href="##" class="navbar-brand " style="font-size: 22px;text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;全国各省麻疹发病率分年统计散点视图（单位：1/1万）&nbsp;</a>
						<span style="margin-left: 250px;" >	
						<select class='prov' id='prov' onchange='changeCity()'style="width: 300px;height: 30px;margin-top: 8px;" >
					          <option value=''>--请选择时间区间--</option> </select> 
					    <select class='city' id='city' style="width: 300px;height: 30px;">
	...
	<script type="text/javascript">
		...
		$('#submit').on('click', function() {
			...
			$.ajax({
				//接口地址  
				url : "ActionYearSeakchance.action?year =" + year,
				//请求方式  
				type : 'get',
				//返回数据类型  
				dataType : 'json',
			...
			$.ajax({
				type : 'get',
				url : "ActionYearSeakchanceTop.action?year="+year,
				/* data : JSON.stringify({
					'kind' : 'top'
				}), */
			...
			$.ajax({
				type : 'get',
				url : "ActionYearSeakchanceMin.action?year="+year,
				/* data : JSON.stringify({
					'kind' : 'top'
				}), */
				contentType : 'application/json; charset=UTF-8',
